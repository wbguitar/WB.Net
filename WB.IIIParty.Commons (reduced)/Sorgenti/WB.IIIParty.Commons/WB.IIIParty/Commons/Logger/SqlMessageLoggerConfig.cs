...
namespace WB.IIIParty.Commons.Logger
{
    ...
    /// </summary>
    public class SqlMessageLoggerConfig : SqlBaseLoggerConfig, ILoggerConfig
    {
        #region Field
        ...
        public SqlMessageLoggerConfig(string _loggerName, string _schema, string _database, string _userName,
            string _password, string _tableName, LogLevels _logLevel,  ICommandToTable _commandToTable)
        ...
        {
            return new SqlMessageLogger(this.Name, this.InitialLevel, this, true); 
        }
