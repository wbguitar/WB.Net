...
namespace WB.IIIParty.Commons.Logger
{
    ...
    /// </summary>
    public class SqlTraceLoggerConfig : SqlBaseLoggerConfig, ILoggerConfig
    {
        #region Field
        ...
        public SqlTraceLoggerConfig(string _loggerName, string _schema, string _database, string _userName,
            string _password, string _tableName,ICommandToTable _commandToTable) : base(_loggerName, _schema, _database, _userName,
        ...
        /// </summary>
        /// <returns></returns>
        object ILoggerConfig.Create()
        {
            return new SqlTraceLogger(this.Name, this.InitialLevel, this); 
        }
